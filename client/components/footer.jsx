...
const Footer = () => {
    return (
        <footer className="bg-gray-200 mt-[10rem] antialiased">
            <div className="p-4 py-6 mx-auto max-w-screen-xl md:p-8 lg:p-10">
                ...
                <div className="text-center">
                    <Link href="#" className="flex justify-center items-center mb-5 text-2xl font-semibold text-gray-900 ">
                    ...
                    <span className="block text-sm text-center text-gray-500 ">© 2024 <Link href="#" className="hover:underline">Blog App</Link>. All Rights Reserved.
                    </span>
